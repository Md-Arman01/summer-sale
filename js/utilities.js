    ...
    document.getElementById("apply-input-field").addEventListener("keyup", function (event) {
        ...
        document.getElementById("apply-btn").addEventListener("click", function () {
            if (text === "SELL200") {
              ...
              const withDiscount =
                totalPrice - withOutDiscount * discountPercent;
              ...
              const payTotalField = document.getElementById("payTotal");
              const payTotalWithDiscount =
                toDecimalTotalPrice - toDecimalDiscountPrice;
              const toDecimalPayTotalWithDiscount =
                payTotalWithDiscount.toFixed(2);
